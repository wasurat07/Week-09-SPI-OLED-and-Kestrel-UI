...
- เหตุผล UART มีความเร็วส่งข้อมูลช้าที่สุด (11.5 KB/s) เมื่อเทียบกับ SPI2 (10 MHz) และ 
ADC1 (ใช้เวลาเพียงระดับ µs) หากมีการส่งข้อความยาวหรือเกิด Blocking I/O จะทำให้เกิดความหน่วงสูงที่สุด
```
